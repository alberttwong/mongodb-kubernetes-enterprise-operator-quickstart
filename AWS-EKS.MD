...
1. Create a mongodb-opsmgr.yaml and `kubectl apply -f mongodb-opsmgr.yaml -n mongodb`.   If you need to edit this `kubectl edit mongodbopsmanager.mongodb.com/om`
    ```
    ---
